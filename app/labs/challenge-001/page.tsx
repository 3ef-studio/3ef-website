...
import { Trophy, Hammer, Timer, Sparkles, Link2, ShieldCheck } from "lucide-react";
    ...
    <div className="mx-auto max-w-5xl space-y-16 px-4 py-16">
      ...
      <section className="relative overflow-hidden rounded-3xl border border-border bg-card px-6 py-12 text-center sm:px-10">
        ...
        <div className="relative space-y-5">
          ...
          <p className="mx-auto max-w-2xl text-muted-foreground">
            Build a real, usable product in 24 hours. Submit a live demo and a short
            write-up (including the AI tools/workflow you used). Winner earns cash
          ...
          <div className="flex flex-col items-center justify-center gap-3 sm:flex-row">
            ...
            {/* Intentionally hidden until challenge is active
            <a
          ...
          <p className="text-xs text-muted-foreground">
            Prompt is revealed at kickoff. Timing and reminders are shared with registered
      ...
      <section className="space-y-4">
        ...
        <p className="text-sm text-muted-foreground">
          A fast, constrained build sprint for vibe coders who can ship under pressure.
          You’ll get a clear prompt at kickoff, build a focused MVP in 24 hours, and
          submit a live, usable product.
        </p>
      ...
      <section className="space-y-6">
        ...
        <div className="grid gap-6 md:grid-cols-2">
          ...
          <div className="space-y-3 rounded-2xl border border-border bg-card p-6 shadow-soft">
            ...
            <p className="text-sm text-muted-foreground">
              Provide a live demo and a short write-up. Include a brief Build Disclosure
              (tools, workflow, and what was built during the window).
            </p>
            <OutputBlock>
        ...
        <div className="grid gap-6 md:grid-cols-3">
          <div className="rounded-2xl border border-border bg-background p-6 shadow-sm">
            ...
            <ul className="mt-3 space-y-1 text-sm text-muted-foreground">
              <li>
                <strong>Opens:</strong> Wed, Jan 14
              </li>
              <li>
                <strong>Closes:</strong> Fri, Feb 6 @ 11:59pm CST
              </li>
            </ul>
          </div>
          ...
          <div className="rounded-2xl border border-border bg-card p-6 shadow-soft">
            ...
            <ul className="mt-3 space-y-1 text-sm text-muted-foreground">
              <li>
                <strong>Prompt:</strong> Sat, Feb 7 @ 9:00am CST
              </li>
              <li>
                <strong>Window:</strong> 24 hours
              </li>
              <li>
                <strong>Submit by:</strong> Sun, Feb 8 @ 9:00am CST
              </li>
            </ul>
          </div>
          ...
          <div className="rounded-2xl border border-border bg-background p-6 shadow-sm">
            ...
            <ul className="mt-3 space-y-1 text-sm text-muted-foreground">
              <li>
                <strong>Judging:</strong> Feb 8–10
              </li>
              <li>
                <strong>Winner:</strong> Wed, Feb 11
              </li>
            </ul>
          </div>
        </div>
      ...
      <section className="space-y-6">
        <div className="space-y-2">
          <div className="flex items-center gap-2">
            ...
            <h2 className="text-xl font-semibold">Build rules & constraints</h2>
          </div>
          <p className="text-sm text-muted-foreground">
        ...
        <div className="grid gap-6 md:grid-cols-2">
          <RuleCard
            title="Build window"
            body="The official build window is 24 hours. Planning is fine beforehand, but active building should happen during the window."
          />

          <RuleCard
            title="Tools, reuse & AI"
            body="Allowed. This is not a from-scratch purity test."
            bullets={[
          ...
          <RuleCard
            title="Build disclosure (required)"
            body="Each submission must include a short disclosure so judging has context."
            bullets={[
          ...
          <RuleCard
            ...
            body="Keep the demo coherent and usable."
            bullets={[
        ...
        <div className="rounded-2xl border border-border bg-card p-6 shadow-soft">
          <p className="text-sm text-muted-foreground">
            <span className="font-medium text-foreground">Open source is optional.</span>{" "}
            If you choose to share your repo/prompts/process publicly, we may highlight it in the post-challenge recap
      ...
      <section className="space-y-6">
        ...
        <div className="rounded-2xl bg-card p-6 shadow-soft">
          <ul className="list-disc list-inside space-y-2 text-sm text-muted-foreground">
            <li>
              <span className="font-medium text-foreground">Live demo URL</span> (required)
            </li>
            <li>
              <span className="font-medium text-foreground">200–400 word write-up</span> (required): who it’s for,
              what it solves, what you did not build, what you’d do with two more weeks
            </li>
            <li>
              <span className="font-medium text-foreground">Build Disclosure</span> (required): what was pre-existing,
              what you built in the 24h window, AI tools/workflow used, paid tools/APIs used
            </li>
      ...
      <section className="space-y-6">
        ...
        <div className="grid gap-6 md:grid-cols-2">
          <div className="space-y-3 rounded-2xl border border-border bg-background p-6 shadow-sm">
            ...
            <p className="text-sm text-muted-foreground">
              Winner receives <span className="font-medium">10–25%</span> of the total entry fees
              (percentage depends on participation).
            </p>
            <OutputBlock>A clean, simple payout tied to participation.</OutputBlock>
          </div>
      ...
      <section className="space-y-4">
        ...
        <div className="rounded-2xl border border-border bg-background p-6 shadow-sm">
          <ul className="grid gap-2 text-sm text-muted-foreground md:grid-cols-2">
            ...
            <li>Vibe coding effectiveness (tools/workflow) — 10%</li>
            <li>Write-up + disclosure quality — 5%</li>
          </ul>
      ...
      <section className="space-y-4">
        ...
        <div className="rounded-2xl bg-card p-6 shadow-soft">
          <ul className="list-disc list-inside space-y-2 text-sm text-muted-foreground">
            ...
            <li>Live demo required</li>
            <li>Build Disclosure required</li>
            <li>Mocked/hardcoded data allowed; real APIs optional</li>
            <li>Open source optional (encouraged)</li>
          </ul>
